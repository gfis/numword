/*  MetaInfView.java - show meta data
...
public class MetaInfView {
     ...
     */
    public MetaInfView() {
        log = Logger.getLogger(MetaInfView.class.getName());
    } // constructor()
    ...
    public void forward(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            out.write("</head>\n<body>\n");
            String CVSID = "@(#) $Id: 8d5e24e355fe592d9ce9ed6d7ba4f4a174079723 $";
            String line = null;
            ...
            out.write("</pre>\n</tt>\n<p>\nBack to the <a href=\"servlet?view=index\">Numword input form</a>\n");
